...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#12100f] px-4 py-10">
      <div className="w-full max-w-md">
        ...
        <div className="bg-[#1c1917] border border-[#33302c] rounded-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-sm text-[#948b80] mb-1">I am a</label>
              <select
                name="role"
                value={formData.role}
                onChange={handleChange}
                className="w-full px-4 py-2.5 rounded-lg bg-[#12100f] border border-[#33302c] text-[#ede9e3] focus:outline-none focus:border-[#c9a26d] transition"
              >
                <option value="user">User — looking for a workspace</option>
                <option value="owner">Owner — listing a workspace</option>
              </select>
            </div>
        ...
        <p className="text-center text-[#948b80] text-sm mt-6">
          ...
          <Link to="/login" className="text-[#c9a26d] hover:underline">
            Log in
          </Link>
        </p>
      </div>
